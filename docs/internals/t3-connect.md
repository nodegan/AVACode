...
T3CODE_PORT=13773 \
  "/Applications/AVA Code (Alpha).app/Contents/MacOS/AVA Code (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/AVA Code (Alpha).app"
codesign -d --entitlements :- "/Applications/AVA Code (Alpha).app"
```
