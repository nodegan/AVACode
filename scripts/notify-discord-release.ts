  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new AVA Code prerelease is available for nightly testers."
          : "A new AVA Code latest release is available.",
...
).pipe(Command.withDescription("Post a AVA Code release announcement to Discord."));
