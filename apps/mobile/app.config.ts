    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active AVA Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow AVA Code to connect to AVA Code servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow AVA Code to access your camera so you can scan pairing QR codes.",
