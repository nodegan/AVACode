...
function getGnomeKeyringRemediationMessage(): string {
  return "AVA Code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart AVA Code.";
}

function getKWalletRemediationMessage(): string {
  return "AVA Code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart AVA Code.";
}
