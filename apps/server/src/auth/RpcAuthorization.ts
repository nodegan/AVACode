...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.gitGraphLog]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGraphCommitFiles]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGraphCommitDiff]: AuthOrchestrationReadScope,
