...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "new-task-thread-in";
}
...
export type CommandPaletteUiAction =
  ...
  | { readonly _tag: "OpenNewTaskThreadIn" }
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenNewTaskThreadIn":
      return { open: true, mode: "command", openIntent: { kind: "new-task-thread-in" } };
